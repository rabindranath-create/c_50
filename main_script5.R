...
dir.create("outputs/script5", recursive = TRUE)
...
saveRDS(results_0, file = "data_50_5_0.rds")
...
saveRDS(results_05, file = "data_50_5_05.rds")
...
saveRDS(results_1, file = "data_50_5_1.rds")
...
saveRDS(results_15, file = "data_50_5_15.rds")
...
saveRDS(results_2, file = "data_50_5_2.rds")
...
saveRDS(results_25, file = "data_50_5_25.rds")
...
saveRDS(results_3, file = "data_50_5_3.rds")
...
saveRDS(results_35, file = "data_50_5_35.rds")
...
saveRDS(results_4, file = "data_50_5_4.rds")
