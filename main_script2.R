...
dir.create("outputs/script2", recursive = TRUE)
...
saveRDS(results_0, file = "data_50_2_0.rds")
...
saveRDS(results_05, file = "data_50_2_05.rds")
...
saveRDS(results_1, file = "data_50_2_1.rds")
...
saveRDS(results_15, file = "data_50_2_15.rds")
...
saveRDS(results_2, file = "data_50_2_2.rds")
...
saveRDS(results_25, file = "data_50_2_25.rds")
...
saveRDS(results_3, file = "data_50_2_3.rds")
...
saveRDS(results_35, file = "data_50_2_35.rds")
...
saveRDS(results_4, file = "data_50_2_4.rds")
