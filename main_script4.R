...
dir.create("outputs/script4", recursive = TRUE)
...
saveRDS(results_0, file = "data_50_4_0.rds")
...
saveRDS(results_05, file = "data_50_4_05.rds")
...
saveRDS(results_1, file = "data_50_4_1.rds")
...
saveRDS(results_15, file = "data_50_4_15.rds")
...
saveRDS(results_2, file = "data_50_4_2.rds")
...
saveRDS(results_25, file = "data_50_4_25.rds")
...
saveRDS(results_3, file = "data_50_4_3.rds")
...
saveRDS(results_35, file = "data_50_4_35.rds")
...
saveRDS(results_4, file = "data_50_4_4.rds")
